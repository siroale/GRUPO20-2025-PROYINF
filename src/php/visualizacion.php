                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="ml-auto">
                        <form action="includes/logout.php" method="POST">
                            <!-- El formulario para hacer logout -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="map_text">
                        <a href="#"><img src="../images/map-icon.png" class="image_main"><span class="padding_left_10">Loreley 1582, La Reina, Santiago</span></a>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <div class="map_text">
                        <a href="#"><img src="../images/call-icon.png" class="image_main"><span class="padding_left_10">+562 2431 3000</span></a>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <div class="map_text">
                        <a href="#"><img src="../images/mail-icon.png" class="image_main"><span class="padding_left_10">contacto@fia.cl</span></a>
                    </div>
                </div>
            </div>
        </div>
