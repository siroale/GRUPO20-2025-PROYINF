    ...
    <?php if ($page === 'login'): ?>
        <form class="form_container">
            ...
            <div class="input_container">
                ...
                <input placeholder="nombre@mail.com" name="input-name" type="text" class="input_field" id="email_field">
            </div>
            <div class="input_container">
                ...
                <input placeholder="Contraseña" name="input-name" type="password" class="input_field" id="password_field">
            </div>
        ...
        <form class="form_container">
            ...
            <div class="register-form">
                ...
                <div class="input_container">
                    ...
                    <input id="email_field" class="input_field" type="text" name="input-name" title="Inpit title" placeholder="nombre@mail.com">
                </div>
                ...
                <div class="input_container">
                    ...
                    <input id="password_field" class="input_field" type="password" name="input-name" title="Inpit title" placeholder="Contraseña">
                </div>
